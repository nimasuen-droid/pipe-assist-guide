    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Pipe Support Smart Assist · Engineering decision-support tool
        </p>
      </div>
      ...
      <Card>
        ...
        <CardContent className="text-sm text-muted-foreground leading-relaxed space-y-2">
          <p>
            Pipe Support Smart Assist guides piping engineers through pipe support selection with
            explicit traceability to ASME B31.3 and MSS standards. It is purpose-built for fast,
            defensible screening during FEED, detailed design and brownfield revamps.
          </p>
          <p>
            Outputs include a primary recommendation, alternates, design and follow-up checks,
            allowed/restrained movements, risk flags and a project-level register and MTO.
          </p>
          <p>
            See the{" "}
            ...
            , the{" "}
            <Link to="/codes" className="text-primary hover:underline">
              Codes & References
            </Link>
            , and the{" "}
            ...
            return (
              <div key={r.v} className="border-l-2 border-primary/40 pl-4">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-xs flex items-center gap-1 text-foreground/80">
      ...
      <Card>
        ...
        <CardContent className="text-sm text-muted-foreground">
          Report defects, request dataset updates or send feedback through your project channel.
          Always validate outputs against the latest approved revision of governing codes.
        </CardContent>
      </Card>
